...
let content = [
    div [class' "container"] [
        //div [class' "row"] [
        h2 [class' "text-center"] [rawText "Jonathan Tyson"]
        ...
        div [class' "row"] [
            div [class' "col-12 col-sm-6"] [
                span [class' "text-bold"] [rawText "NextGen Healthcare"]
                br []
                span [class' "text-italic"] [rawText "Buckhead, GA"]
            ]
            div [class' "col-12 col-sm-6"] [
                span [class' "text-bold"] [rawText "Software Engineer and Intern"]
                br []
                span [class' "text-italic"] [rawText "3/2015-9/2018"]
            ]
        ]
        ul [] [
        ...
        span [class' "text-bold"] [rawText "Accomplishments"]
        ul [] [
